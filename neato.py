...
REQUIREMENTS = ['https://github.com/dshokouhi/pybotvac/archive/0.0.12dev.zip'
                '#pybotvac==0.0.12dev']
DOMAIN = 'neato'
...
ALERTS = {
    ...
    'nav_floorplan_load_fail': 'No floorplan found',
    'nav_floorplan_localization_fail': 'Floorplan no longer matches surroundings'
}
